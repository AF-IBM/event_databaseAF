...
The sources for this website are in the GitHub repo's [`docs`](https://github.com/The-AI-Alliance/event_database/tree/main/docs){:target="repo-docs"} directory. 
